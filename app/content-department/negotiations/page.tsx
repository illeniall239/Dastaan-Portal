...
export default async function ContentDepartmentNegotiationsPage() {
  ...
  // Content department users can create negotiations
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mobile-header-spacing">
        <div>
          ...
          <p className="text-muted-foreground mt-2 text-sm sm:text-base">
            Manage project negotiations and term sheets
          </p>
        </div>
        {canCreate && (
          <Button asChild>
            <Link href="/content-department/negotiations/new">
