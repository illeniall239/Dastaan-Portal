...
export default function ContentDepartmentCallReportsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    Sentry.captureException(error, {
      level: "error",
      tags: {
        error_boundary: "content_dept_call_reports",
        location: "content-department-call-reports-page",
      },
      contexts: {
        error: {
          digest: error.digest,
    ...
    if (process.env.NODE_ENV === "development") {
      console.error("Content department call reports page error:", error);
    }
  }, [error]);
