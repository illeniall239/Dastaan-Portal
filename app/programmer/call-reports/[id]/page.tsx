...
export default async function ProgrammerCallReportDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Only allow programmers and admins to access this page
  ...
  const reportWriters = writers?.map((w: WriterData) => ({
    id: w.id,
