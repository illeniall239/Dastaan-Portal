...
export default async function ProgrammerDetailedOneLinerPage({
  params,
}: {
  ...
  // Check if user can edit (owner or management/admin)
  const canEdit =
          ...
          <div className="flex items-center justify-between">
            ...
            {canEdit && (
              <Button asChild variant="default" size="sm">
                <Link href={`/programmer/detailed-one-liner/${id}/edit`}>
