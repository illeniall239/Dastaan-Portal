...
export default function EvaluatorContractTermsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    Sentry.captureException(error, {
      level: "error",
      tags: {
        error_boundary: "evaluator_contract_terms",
        location: "evaluator-contract-terms-page",
      },
      contexts: {
        error: {
          digest: error.digest,
    ...
    if (process.env.NODE_ENV === "development") {
      console.error("Evaluator contract terms page error:", error);
    }
  }, [error]);
