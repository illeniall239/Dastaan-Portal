...
export default async function GcmCallReportDetailedOneLinerPage({
  params,
}: {
    ...
    <div className="mobile-container mobile-section">
      <div className="mobile-header-spacing">
        ...
        <div className="flex items-center gap-4 mb-6">
          <BackButton fallbackHref="/gcm/call-reports" variant="outline" />
          {canEdit && detailedOneLiner && (
            <Button asChild variant="default" size="sm">
              <Link href={`/gcm/detailed-one-liner/${detailedOneLiner.id}/edit`}>
