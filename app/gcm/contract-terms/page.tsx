...
export default async function GcmContractTermsPage() {
  ...
  if (
    !userData ||
    !["gcm", "admin"].includes(userData.role)
  ) {
    redirect("/dashboard");
  }
  ...
  // GCM users can create contract terms
  const canCreate = userData.role === "gcm" || userData.role === "admin";
        ...
        <div className="flex items-center justify-between">
          ...
          {canCreate && (
            <Button asChild className="touch-target">
              <Link href="/gcm/contract terms/new">
