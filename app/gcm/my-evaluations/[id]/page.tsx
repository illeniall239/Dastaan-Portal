...
export default async function GcmEvaluationDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    <div className="mobile-container mobile-section space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 mb-8">
        <div className="flex items-center justify-between">
          <BackButton fallbackHref="/gcm/evaluations-list?view=completed" variant="outline" size="sm" className="w-fit" />
          <div className="flex items-center gap-3">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href={`/gcm/evaluate/${evaluation.call_report_id}?edit=1`}>
                Edit
              </Link>
            </Button>
          </div>
