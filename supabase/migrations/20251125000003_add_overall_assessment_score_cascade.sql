...
-- This version uses CASCADE to handle all trigger dependencies
...
DROP FUNCTION IF EXISTS calculate_evaluation_average() CASCADE;

-- Create updated function to calculate average from 5 scores
...
-- Create trigger with the correct name that matches the existing schema
...
-- Create updated function to calculate average from 6 scores
