-- Fix: use original_submission_date (when available) for first/last episode received dates
-- original_submission_date is a DATE column for backdated/historical entries;
-- fall back to created_at (timestamptz) when it is NULL.
