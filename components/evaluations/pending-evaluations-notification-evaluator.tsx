...
export async function PendingEvaluationsNotificationEvaluator({ userId, userName }: PendingEvaluationsNotificationProps) {
  try {
            ...
            <div className="flex-1">
              ...
              <div className="mt-4">
                <Link
                  ...
                  className={`inline-flex items-center px-3 py-2 rounded-md text-sm font-medium ${isUrgent ? 'bg-red-600 hover:bg-red-700 text-white' : 'bg-yellow-600 hover:bg-yellow-700 text-white'}`}
                >
