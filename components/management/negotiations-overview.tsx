...
interface NegotiationsOverviewProps {
  negotiations: any[];
}

export function NegotiationsOverview({ negotiations }: NegotiationsOverviewProps) {
  ...
  const stats = {
    ...
    total_agreed_value: negotiations
  ...
  return (
    <div id="negotiations-overview" className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Negotiations Overview</h2>
        <Link
          href="/management/negotiations"
