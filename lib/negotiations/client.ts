...
export interface StoryForNegotiation {
  id: string;
  story_id: string;
  title: string;
 ...
 */
export async function getApprovedStoriesForNegotiation(): Promise<{
  data: StoryForNegotiation[] | null;
  error: Error | null;
}> {
 ...
 */
export async function getNegotiationById(id: string): Promise<{
  data: Negotiation | null;
  error: Error | null;
}> {
  const supabase = createClient();
...
/**
 * Create a new negotiation from client components
 * This function should be called from client components
 */
export async function createNegotiationClient(
 ...
 */
export async function updateNegotiationClient(
  id: string,
 ...
 */
export async function deleteNegotiationClient(id: string): Promise<{
  success: boolean;
  error: Error | null;
}> {
  const supabase = createClient();
