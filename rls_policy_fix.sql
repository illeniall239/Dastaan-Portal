-- =====================================================
-- Week 3: RLS Policy Improvements - FIXED VERSION
-- =====================================================
...
DROP POLICY IF EXISTS "Management and programmers can create external links" ON public.external_evaluation_links;
...
DROP POLICY IF EXISTS "Management and programmers can update external links" ON public.external_evaluation_links;
